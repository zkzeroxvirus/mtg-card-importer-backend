...
/**
 * Check if card is a test card or has acorn security stamp
 * Test cards are from Mystery Booster playtest sets (cmb1, mb2, cmb2)
 * Acorn stamped cards are not tournament legal (used for casual/Un-sets)
 */
...
async function getRandomCard(query = '', suppressLog = false) {
  ...
  // Exclude test cards and acorn-stamped (not tournament legal) cards from random results
