...
/**
 * File-backed tag cache for tagger-based Scryfall queries.
 *
 * Oracle taggers (otag:/oracletag:/function:/native:) can now be hydrated from
 * Scryfall's Oracle Tags bulk export. This cache stores resolved oracle_id pools
 * so workers and restarts can reuse lookups quickly.
 *
 * Non-oracle taggers (for example arttag:) may still require API fallback.
 *
